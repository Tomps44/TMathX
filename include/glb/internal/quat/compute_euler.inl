...
#               if defined(GLB_SET_ROTATION_ORDER_XYZ)
                    return glbDetail::FromEuler_XYZ(x, y, z);

#               elif defined(GLB_SET_ROTATION_ORDER_XZY)
                    return glbDetail::FromEuler_XZY(x, y, z);

#               elif defined(GLB_SET_ROTATION_ORDER_YXZ)
                    return glbDetail::FromEuler_YXZ(x, y, z);

#               elif defined(GLB_SET_ROTATION_ORDER_YZX)
                    return glbDetail::FromEuler_YZX(x, y, z);

#               elif defined(GLB_SET_ROTATION_ORDER_ZXY)
                    return glbDetail::FromEuler_ZXY(x, y, z);

#               else // GLB_SET_ROTATION_ORDER_ZYX
                    return glbDetail::FromEuler_ZYX(x, y, z);
...
#           endif
    ...
    namespace glbDetail
    {
        ...
        template<typename T>
        GLB_INLINE constexpr quat<T> FromEuler_XYZ(T x, T y, T z) noexcept
        {
        ...
        template<typename T>
        GLB_INLINE constexpr quat<T> FromEuler_XZY(T x, T y, T z) noexcept
        {
            const T halfX = x * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
            const T halfY = y * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
            const T halfZ = z * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
        ...
        template<typename T>
        GLB_INLINE constexpr quat<T> FromEuler_YXZ(T x, T y, T z) noexcept
        {
            const T halfX = x * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
            const T halfY = y * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
            const T halfZ = z * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
        ...
        template<typename T>
        GLB_INLINE constexpr quat<T> FromEuler_YZX(T x, T y, T z) noexcept
        {
            const T halfX = x * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
            const T halfY = y * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
            const T halfZ = z * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
        ...
        template<typename T>
        GLB_INLINE constexpr quat<T> FromEuler_ZXY(T x, T y, T z) noexcept
        {
            const T halfX = x * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
            const T halfY = y * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
            const T halfZ = z * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
        ...
        template<typename T>
        GLB_INLINE constexpr quat<T> FromEuler_ZYX(T x, T y, T z) noexcept
        {
            const T halfX = x * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
            const T halfY = y * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
            const T halfZ = z * static_cast<T>(0.5) * static_cast<T>(0.0174532925199432957691391462423657899L);
