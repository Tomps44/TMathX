...
namespace glb
{
    ...
    public:
        ...
        GLB_INLINE constexpr mat(T x0, T y0, T z0, T w0,
                                 T x1, T y1, T z1, T w1,
                                 T x2, T y2, T z2, T w2,
                                 T x3, T y3, T z3, T w3) noexcept;
        GLB_INLINE constexpr mat(T scalar = static_cast<T>(1.0)) noexcept;
        GLB_INLINE constexpr mat(const colType& v1, const colType& v2, const colType& v3, const colType& v4) noexcept;
...
#include "glb/internal/mat/type_mat4x4.inl"